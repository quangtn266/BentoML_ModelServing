...
# set this to true if you want to plot Principal Components visualization in browser
# using pyplot
is_plot = True
...
df_features = pd.read_csv("/Users/quangtn/Desktop/01_work/01_job/"
                          "02_ml/bentoml/prj/Chapter_2/data_preproessing/"
                          "HR_comma_sep_2.csv")
...
# Assign integer value for each categorical value (Each research_interest) and
...
df_x = df_features[["satisfaction_level", "last_evaluation", "number_project",
    "average_montly_hours", "time_spend_company", "Work_accident",
    "promotion_last_5years", "sales_int", "salary_int"]]
...
# Step1: Scale the dataset
scaler = StandardScaler()

# train = scaler.fit(X)
X_std = scaler.fit_transform(X)

# Step2: Instance PCA & choose minimum number of components such that it covers
# 95% variance
...
### Visualize pca component as matrix. set variance is_plot=true for below plot
# to word
